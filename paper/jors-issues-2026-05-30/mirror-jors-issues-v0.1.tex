...
The software, tests, fixtures, paper source, and minimal public-safe evidence package for this article are available in the Zenodo software record for MIRROR (16), DOI \url{https://doi.org/10.5281/zenodo.20463358}, under the Apache License 2.0. The minimal evidence package is included as \texttt{release/mirror-methodology-rc1/} inside the archived \texttt{v0.1.1} package.
