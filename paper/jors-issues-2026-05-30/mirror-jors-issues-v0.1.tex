...
The software, tests, fixtures, and minimal public-safe evidence package for this article are available in the public release repository at \url{https://github.com/sapsan14/mirror-evidence-bundles} under the Apache License 2.0 and are archived on Zenodo (16). The minimal evidence package is in \texttt{release/mirror-methodology-rc1/}; the archived release target is \texttt{v0.1.0}.
...
Author used OpenAI Codex model GPT5.5 for final draft polishing. The author remains responsible for all claims, references, omissions, and decisions.
...
16. Sokolov A. MIRROR: Local Evidence Bundles for Reproducible Research Software Review. Zenodo; 2026. DOI: \url{https://doi.org/10.5281/zenodo.20462185}.
